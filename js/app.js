...
var TodoModel = function TodoModel(data) {
...
exports['default'] = function (ctrl) {
  ...
  return (0, _mithril2['default'])('footer#footer', [(0, _mithril2['default'])('span#todo-count', [(0, _mithril2['default'])('strong', amountActive), ' item' + (amountActive !== 1 ? 's' : '') + ' left']), (0, _mithril2['default'])('ul#filters', [(0, _mithril2['default'])('li', [(0, _mithril2['default'])('a[href=/]', {
    config: _mithril2['default'].route,
    'class': ctrl.filter() === '' ? 'selected' : ''
  }, 'All')]), (0, _mithril2['default'])('li', [(0, _mithril2['default'])('a[href=/active]', {
    config: _mithril2['default'].route,
    'class': ctrl.filter() === 'active' ? 'selected' : ''
  }, 'Active')]), (0, _mithril2['default'])('li', [(0, _mithril2['default'])('a[href=/completed]', {
    config: _mithril2['default'].route,
    'class': ctrl.filter() === 'completed' ? 'selected' : ''
  }, 'Completed')])]), ctrl.amountCompleted() === 0 ? '' : (0, _mithril2['default'])('button#clear-completed', {
...
exports['default'] = function (ctrl) {
  var focused = false;
  return [(0, _mithril2['default'])('header#header', [(0, _mithril2['default'])('h1', 'todos'), (0, _mithril2['default'])('input#new-todo[placeholder="What needs to be done?"]', {
    onkeyup: watchInput(ctrl.add.bind(ctrl), ctrl.clearTitle.bind(ctrl)),
    value: ctrl.title(),
    oninput: _mithril2['default'].withAttr('value', ctrl.title),
  ...
  })]), (0, _mithril2['default'])('section#main', {
    style: {
      display: ctrl.list.length ? '' : 'none'
    }
  }, [(0, _mithril2['default'])('input#toggle-all[type=checkbox]', {
    onclick: ctrl.completeAll.bind(ctrl),
    checked: ctrl.allCompleted()
  }), (0, _mithril2['default'])('ul#todo-list', [ctrl.list.filter(ctrl.isVisible.bind(ctrl)).map(function (task, index) {
    return (0, _mithril2['default'])('li', {
      ...
      key: task.key
    }, [(0, _mithril2['default'])('.view', [(0, _mithril2['default'])('input.toggle[type=checkbox]', {
      onclick: _mithril2['default'].withAttr('checked', ctrl.complete.bind(ctrl, task)),
      checked: task.completed()
    }), (0, _mithril2['default'])('label', {
      ondblclick: ctrl.edit.bind(ctrl, task)
    }, task.title()), (0, _mithril2['default'])('button.destroy', {
      onclick: ctrl.remove.bind(ctrl, index)
    })]), (0, _mithril2['default'])('input.edit', {
      value: task.title(),
